...
SET _src=D:\Android\Github\HyperOS-XML-1.0-RUSSIAN\Russian\translators\__repo\
SET _dst=D:\Android\Github\HyperOS-XML-1.0-RUSSIAN\Russian\device\
SET _mnt=D:\Android\Github\HyperOS-XML-1.0-RUSSIAN\Russian\main
