...
SET _src=D:\Android\Github\MA-XML-14-RUSSIAN\Russian\translators\__repo\
SET _dst=D:\Android\Github\MA-XML-14-RUSSIAN\Russian\device\
SET _mnt=D:\Android\Github\MA-XML-14-RUSSIAN\Russian\main
