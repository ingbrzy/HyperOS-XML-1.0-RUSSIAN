...
del %_run%DST\result.xml
%_run%XMLCompare /at /fp /s %_run%SRC\plurals.xml /d %_run%DST\plurals.xml /i %_dat%ignore_p.xml /t %_dat%translate_sel_p.xml /n 4 /silent_t
...
del %_run%DST\result.xml
%_run%XMLCompare /at /fa /s %_run%SRC\arrays.xml /d %_run%DST\arrays.xml /i %_dat%ignore_a.xml /t %_dat%translate_sel_a.xml /n 4 /silent_t
